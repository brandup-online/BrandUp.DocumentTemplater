namespace BrandUp.DocumentTemplater.Handling
{
    ...
    /// </summary>
    public class HandleResult(object dataContext)
    {
        /// <summary>
        /// Новый контекст выполнения
        /// </summary>
        public object DataContext { get; } = dataContext ?? throw new ArgumentNullException(nameof(dataContext));
        ...
        /// </summary>
        public CommandOutputType OutputType { get; set; } = CommandOutputType.None;
